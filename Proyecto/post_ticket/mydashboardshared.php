                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Tasques <button class="btn btn-success xcrear_tasca ml-3">Crear Tasca</button></h5>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body border-top">
                                        <h3 class="font-16">Buscar per Categories</h3>
                                        <div class="xbuscador_categories">
                                        </div>
                                    </div>
                                    <div class="card-body border-top">
                                        <h3 class="font-16">Buscar per Usuaris</h3>
                                        <div class="xbuscador_usuaris">
                                        </div>
                                    </div>
                                    <div class="card-body border-top">
                                        <a href="#" class="btn btn-secondary btn-lg btn-block xbtn_buscar">Filtrar</a>
                                    </div>
                                </div>
                            </div>
                            <!-- ============================================================== -->
